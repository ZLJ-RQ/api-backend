...
import com.api.common.model.enums.InterfaceInfoStatusEnum;
...
public class InterfaceInfoController {
    ...
    public BaseResponse<Boolean> onlineInterfaceInfo(@RequestBody IdRequest idRequest,
        ...
        try {
            ...
            throw new BusinessException(ErrorCode.SYSTEM_ERROR,"编码格式异常");
        }
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest invokeRequest,
        ...
        //判断接口是否上线
        if (oldInterface.getStatus()!=InterfaceInfoStatusEnum.ONLINE.getValue()){
        ...
        Gson gson = new Gson();
        com.api.apiclientsdk.model.User user = null;
        try {
            user = gson.fromJson(requestParams, com.api.apiclientsdk.model.User.class);
        } catch (JsonSyntaxException e) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR,"请求参数格式错误");
        }
        String usernameByPost=null;
        try {
             usernameByPost = apiClient.getUsernameByPost(user);
        } catch (UnsupportedEncodingException e) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR,"编码格式异常");
        }
//        String pic = apiClient.createPic(requestParams);
